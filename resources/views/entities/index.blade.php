		...
		<div class="row">
			<div class="medium-8 large-7 small-10 columns">
				<div class="content-hero">
					<h1><span style=" background-color:lightblue;">The ultimate technology enhancement for residential dementia care.</span>
					</h1>
					<h3><span style="color:#000; background-color:lightblue;">CareBand combines cutting-edge location and activity monitoring technologies with brilliant design to empower people with dementia and their caregivers.</span></h3>
				</div>
			</div>
			...
			@foreach($country->random() as $country)
				<div class="col-md-3 padding-columns">
					<a href="{{ route('country.show', $country['links']) }}">
						<div class="box_spesializations_home">
							<div class="img_spesializations_home">
								<img src="{{asset('./img/paktoto.jpeg')}}">
							</div>
							<div class="content_spesializations_home">
								<h1>{{ $country['name'] }}</h1>
							</div>
		...
		<div class="row">
			<div class="small-12 columns">
				...
				<div class="footer-about__">
					...
					<p>© 2019 <a href="https://rhivent.github.io" style="color:#00A0C6; text-decoration:none; cursor:pointer;">Riventus<a></p>
				</div>
			</div>
		</div>
	</section>
